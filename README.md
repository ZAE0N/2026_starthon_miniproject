...
**▶ 실행 링크 — http://15.165.117.153/**

설치도 로그인도 필요 없습니다. 링크만 누르면 됩니다.

우하단 **AI 도우미**를 열고 `이번 주 마감인 장학금 알려줘` 를 누르면,
답변과 **동시에 왼쪽 공지 목록이 71건에서 4건으로 바뀝니다.**
...
| 물어보면 | 화면이 |
|---|---|
| 이번 주 마감인 장학금 알려줘 | 장학 탭으로 이동 + 마감 조건 칩 + 71 → **4건** |
...
브라우저
   │  http://15.165.117.153/
   ▼
nginx :80 ─────┬── /        →  /var/www/inhatc     (HTML · CSS · JS)
